...
- [ ] Phase 1 Batch A (12 items)
- [ ] Phase 1 Batch B (8 items)
- [ ] Phase 2 Batch A (10 items)
- [ ] Phase 2 Batch B (8 items)
- [ ] Phase 3 Batch A (7 items)
- [ ] Phase 3 Batch B (5 items)
- [ ] Phase 4 Batch A (8 items)
- [ ] Phase 4 Batch B (9 items)
- [ ] Phase 5 Batch A (8 items)
- [ ] Phase 5 Batch B (5 items)
